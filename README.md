...
```
kbb --classpath src:tests -e "(require 'groq_lpu.actor-test) (clojure.test/run-tests 'groq_lpu.actor-test)"
```

## Provenance

Relocated 2026-07-04 from `etzhayyim/root/20-actors/groq_lpu-compat` to
`kotoba-lang/com-groq-lpu` per the org-taxonomy library-placement rule (any
